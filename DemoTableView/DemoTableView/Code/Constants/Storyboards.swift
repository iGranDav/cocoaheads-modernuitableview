...
enum StoryboardScene {
  ...
  enum Main: StoryboardType {
    ...
    static let initialScene = InitialSceneType<DemoTableView.BootViewController>(storyboard: Main.self)

    static let bootViewController = SceneType<DemoTableView.BootViewController>(storyboard: Main.self, identifier: "BootViewController")
  }
}
